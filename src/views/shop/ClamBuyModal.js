...
const ClamBuyModal = ({
  ...
  return (
    <>
      ...
      <div className="div_sm px-2">
        <Card maxHeight="100%">
          <form onSubmit={handleSubmit(onSubmit)} className="px-2 py-2 relative">
            <div className="flex flex-row justify-center items-center mb-6 gap-2">
              <h2 className="text-blue-700 text-center font-semibold text-2xl mb-1">Buy Clam</h2>
              
              {/* <div className="" onClick={() => setBuyWithGem(!buyWithGem)}>
                <label className="label cursor-pointer p-0">
                  <span className="label-text text-xl text-gray-700">Use {buyWithGem ? "GEM" : "BNB"}</span>
                  <div
                    className={clsx(
            ...
            <div className="pt-4 ">
              ...
              <div className="w-full grid gap-1 text-sm">
                <div className="w-full flex flex-row justify-between">
                  <span>Size</span>
                  <div>
                    <span>{selectedGradeData.minSize} to {selectedGradeData.maxSize}</span>
              ...
              <div className="px-2 py-2">
                <div className="flex flex-col">
                  <div className="text-center">
                    <div className="text-lg font-semibold">Price of Grade {selectedGrade.toUpperCase()} Clam</div>
                    <div className="my-2" onClick={() => setBuyWithGem(!buyWithGem)}>
                      <label className="label justify-center cursor-pointer p-0">
                        <span className="label-text">Buy with {buyWithGem ? "GEM" : "BNB"}</span>
                        <div
                          className={clsx(
                            "w-14 h-8 ml-2 rounded-2xl bg-gray-200 flex items-center px-1",
                  ...
                  <div className="flex flex-col text-sm text-gray-600">
                    <div className="flex flex-col">
                      <div className="">
                        ...
                        <div className="flex flex-col my-2 pl-4">
                          <div className="flex justify-between">
                            <span>Wallet:</span>
                            <span>
                              {buyWithGem
                  ...
                  <div className="text-md text-center my-2 text-xs text-gray-400">
                    {mintedThisWeek} Clams purchased this week
                  </div>
                </div>
              </div>
            ...
            <div className="py-2 flex flex-col text-md">
              {disableButton ? (
                <button
                  disabled
                  type="submit"
                ...
                <>
                  {isLoading ? (
                    <button
                      ...
                      style={{ textAlign: "center" }}
                      type="submit"
                      className="flex justify-center items-center block uppercase text-center shadow bg-yellow-200 text-yellow-600 text-sm py-3 px-10 rounded-xl cursor-not-allowed"
                    >
                      <svg
                        className="animate-spin -ml-1 mr-3 h-5 w-5 text-yello-600"
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <button
                      type="submit"
                      className={`block uppercase text-center shadow hover:bg-blue-700 focus:shadow-outline focus:outline-none text-white text-md py-3 px-10 rounded-xl
                          ${canBuy ? "bg-blue-600" : "btn-disabled bg-grey-light"}
                          `}
                    >
                      {canBuy ? "Buy Clam" : "Not enough balance"}
