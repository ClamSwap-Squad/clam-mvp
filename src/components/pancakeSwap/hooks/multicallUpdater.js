...
const {
  ...
  updateMulticallResults: updateMulticallResultsAC,
  errorFetchingMulticallResults: errorFetchingMulticallResultsAC,
} = actions();
 ...
 */
export function outdatedListeningKeys(callResults, listeningKeys, chainId, currentBlock) {
...
export function Updater() {
  const fetchingMulticallResults = useAction(fetchingMulticallResultsAC);
  const updateMulticallResults = useAction(updateMulticallResultsAC);
  const errorFetchingMulticallResults = useAction(errorFetchingMulticallResultsAC);
  ...
  }, [chainId, multicallContract, serializedOutdatedCallKeys, currentBlock]);
