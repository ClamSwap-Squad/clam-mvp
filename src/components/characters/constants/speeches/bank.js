export const BANK_SPEECH = {
  bank: {
    ...
    withdraw_rewards_alert: {
      text: "You still have locked Pearl yield currently streaming. Withdrawing from this pool will cause all pending Pearl streams to be reduced proportionally. If the withdrawn amount is not deposited back within 24 hours, the reduction will become permanent. Are you sure you want to withdraw?",
      next: false,
      dismiss: true,
      skip: false,
    },
